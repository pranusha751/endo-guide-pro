  ...
  return (
    <div className="space-y-6">
      <PageHeader 
        ...
        subtitle="Optimal isolation for endodontics" 
      />
          ...
          {toothInfo && (
            <div className="rounded-2xl bg-peach p-5 border border-peach/20">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <div className="text-[10px] font-bold uppercase tracking-widest text-peach-foreground/60">Recommended Clamp</div>
                  <div className="text-lg font-bold text-peach-foreground">{toothInfo.clamp}</div>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <div className="text-[10px] font-medium uppercase text-peach-foreground/60">Group</div>
                  <div className="text-sm font-semibold text-peach-foreground capitalize">{toothInfo.group}</div>
                </div>
                <div>
                  <div className="text-[10px] font-medium uppercase text-peach-foreground/60">Isolation</div>
      ...
      <div className="space-y-4">
        <h3 className="text-sm font-bold uppercase tracking-wider text-muted-foreground px-1">Clinical Tips</h3>
            ...
            <Card key={tip.category} className="rounded-2xl border-border bg-card">
              <CardContent className="p-4 flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1 leading-relaxed">{tip.details}</p>
                </div>
              </CardContent>
            </Card>
          ))}
