          ...
          return (
            ...
            >
              <div className="flex items-start gap-3">
                <div className={`w-6 h-6 mt-0.5 rounded-full flex items-center justify-center flex-shrink-0 border-2 transition-colors ${
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs text-muted-foreground mt-1 flex flex-wrap gap-x-3 gap-y-1">
                    <span><span className="font-medium">Conc:</span> {step.concentration}</span>
                    <span><span className="font-medium">Vol:</span> {step.volume}</span>
                    <span><span className="font-medium">Time:</span> {step.time}</span>
                  </div>
                </div>
              </div>
            </button>
