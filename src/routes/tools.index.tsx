...
const TOOLS = [
  {
    ...
    color: "mint" as const,
    to: "/tools/file-calculator" as const,
  },
  {
    icon: Droplets,
    ...
    <div>
          ...
          return (
            ...
            >
              <div className="flex items-center gap-4">
                <div
                  className={`w-12 h-12 rounded-2xl bg-${t.color} flex items-center justify-center flex-shrink-0`}
                >
      ...
      <div className="mt-6 rounded-2xl bg-mint/40 border border-mint p-4">
        ...
        <p className="text-xs text-mint-foreground/80 mt-1">
          Run the full guided workflow for best results — it auto-configures every tool based on
          your tooth selection and diagnosis.
        </p>
      </div>
    </div>
  );
