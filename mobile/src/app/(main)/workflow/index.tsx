...
const styles = StyleSheet.create({
  ...
  progressActive: { backgroundColor: '#007bff' },
  ...
  cardTitle: { fontSize: 12, fontWeight: 'bold', color: '#888', textTransform: 'uppercase', marginBottom: 15, letterSpacing: 1 },
  label: { fontSize: 12, fontWeight: '600', color: '#666', marginBottom: 5 },
  input: { backgroundColor: '#f9f9f9', borderWidth: 1, borderColor: '#eee', borderRadius: 8, padding: 12, fontSize: 16, marginBottom: 15 },
  row: { flexDirection: 'row' },
  divider: { height: 1, backgroundColor: '#eee', marginVertical: 15 },
  pickerContainer: { borderWidth: 1, borderColor: '#eee', borderRadius: 8, backgroundColor: '#f9f9f9', overflow: 'hidden' },
  statsGrid: { flexDirection: 'row', flexWrap: 'wrap', marginTop: 15, marginHorizontal: -5 },
  statBox: { backgroundColor: '#e6f2ff', padding: 10, borderRadius: 8, width: '47%', margin: '1.5%', marginBottom: 10 },
  statLabel: { fontSize: 10, fontWeight: 'bold', color: '#007bff', textTransform: 'uppercase' },
  statValue: { fontSize: 14, fontWeight: '600', color: '#333', marginTop: 4 },
  toggleRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#eee' },
  toggleLabel: { fontSize: 16, color: '#333' },
  segGroup: { paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#eee' },
  segRow: { flexDirection: 'row', gap: 8 },
  segBtn: { flex: 1, paddingVertical: 8, borderWidth: 1, borderColor: '#ddd', borderRadius: 8, alignItems: 'center', backgroundColor: '#fff' },
  segBtnActive: { backgroundColor: '#007bff', borderColor: '#007bff' },
  segBtnText: { fontSize: 14, color: '#666', textTransform: 'capitalize' },
  segBtnTextActive: { color: '#fff', fontWeight: 'bold' },
  dxBox: { padding: 15, borderRadius: 12 },
  dxBoxLabel: { fontSize: 12, color: '#555', textTransform: 'uppercase', fontWeight: 'bold' },
  dxBoxTitle: { fontSize: 20, fontWeight: 'bold', color: '#111', marginTop: 5 },
  dxBoxDesc: { fontSize: 14, color: '#333', marginTop: 5 },
  dxItem: { padding: 15, borderWidth: 1, borderColor: '#eee', borderRadius: 12, marginBottom: 10 },
  dxItemActive: { borderColor: '#007bff', backgroundColor: '#e6f2ff' },
  dxItemTitle: { fontSize: 16, fontWeight: 'bold', color: '#333' },
  dxItemDesc: { fontSize: 12, color: '#666', marginTop: 4 },
  toothGraphic: { width: 100, height: 100, borderRadius: 50, backgroundColor: '#d4edda', alignSelf: 'center', justifyContent: 'center', alignItems: 'center', marginBottom: 20, borderWidth: 1, borderColor: '#c3e6cb' },
  toothGraphicText: { fontSize: 32, fontWeight: 'bold', color: '#155724' },
  toothGraphicSub: { fontSize: 12, color: '#155724', opacity: 0.8 },
  liText: { fontSize: 14, color: '#444', marginBottom: 8, lineHeight: 20 },
  irrigItem: { flexDirection: 'row', padding: 15, borderWidth: 1, borderColor: '#eee', borderRadius: 12, marginBottom: 10, backgroundColor: '#fff' },
  irrigItemDone: { backgroundColor: '#d4edda', borderColor: '#c3e6cb' },
  ...
  irrigItemTitle: { fontSize: 15, fontWeight: 'bold', color: '#333' },
  irrigItemDesc: { fontSize: 12, color: '#666', marginTop: 4 },
  warningBox: { backgroundColor: '#fff3cd', borderColor: '#ffeeba', borderWidth: 1, borderRadius: 12, padding: 15, marginTop: 10 },
  warningTitle: { fontSize: 14, fontWeight: 'bold', color: '#856404', marginBottom: 10 },
  warningText: { fontSize: 12, color: '#856404', marginBottom: 5 },
  groupBadge: { backgroundColor: '#ffe8cc', padding: 15, borderRadius: 12, marginBottom: 15 },
  groupBadgeLabel: { fontSize: 12, color: '#fd7e14', textTransform: 'uppercase', fontWeight: 'bold' },
  groupBadgeValue: { fontSize: 18, fontWeight: 'bold', color: '#d9480f', marginTop: 5, textTransform: 'capitalize' },
  tipBox: { borderWidth: 1, borderColor: '#eee', borderRadius: 12, padding: 15, marginBottom: 10 },
  tipBoxTitle: { fontSize: 14, fontWeight: 'bold', color: '#333' },
  tipBoxDesc: { fontSize: 13, color: '#666', marginTop: 5 },
  ...
  saveButton: { backgroundColor: '#007bff', padding: 15, borderRadius: 12, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginTop: 10 },
  ...
  sectionBullet: { width: 20, height: 20, borderRadius: 10, backgroundColor: '#28a745', justifyContent: 'center', alignItems: 'center', marginRight: 10 },
  sectionBulletText: { color: '#fff', fontSize: 10, fontWeight: 'bold' },
  sectionText: { fontSize: 14, color: '#333', flex: 1 },
  footerNav: { position: 'absolute', bottom: 0, left: 0, right: 0, flexDirection: 'row', padding: 15, backgroundColor: '#fff', borderTopWidth: 1, borderTopColor: '#eee', gap: 10 },
  navBtn: { flex: 1, padding: 15, borderRadius: 12, flexDirection: 'row', justifyContent: 'center', alignItems: 'center' },
  navBtnBack: { backgroundColor: '#f0f0f0', borderWidth: 1, borderColor: '#ddd' },
  navBtnNext: { backgroundColor: '#007bff' },
  navBtnTextBack: { color: '#333', fontSize: 16, fontWeight: '600', marginLeft: 5 },
  navBtnTextNext: { color: '#fff', fontSize: 16, fontWeight: '600', marginRight: 5 },
});
