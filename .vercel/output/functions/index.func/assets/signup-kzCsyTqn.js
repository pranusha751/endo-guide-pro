...
import { u as useNavigate, L as Link } from "./router-BviRwo8l.js";
import { B as Button } from "./button-2iViTmHw.js";
import { H as HeartPulse, I as Input, L as LoaderCircle, s as signUpWithPassword } from "./auth-stub-BOSx22Hj.js";
...
function RouteComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-1 items-center justify-center p-6 overflow-y-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "w-full max-w-sm rounded-2xl shadow-sm border-0 sm:border", children: [
