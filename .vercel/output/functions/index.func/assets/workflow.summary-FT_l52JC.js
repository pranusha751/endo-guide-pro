...
import { c as Route, T as TEETH, D as DIAGNOSES, P as PageHeader, a as FILE_PROTOCOLS } from "./router-5bitkNwX.js";
...
function SummaryPage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
      ...
      /* @__PURE__ */ jsxs(Button, { className: "w-full rounded-2xl py-6 text-lg font-bold shadow-soft gap-2", children: [
