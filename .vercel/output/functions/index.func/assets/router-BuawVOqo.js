...
import { useLocation, Outlet, Link, useNavigate, createRootRoute, HeadContent, Scripts, createFileRoute, lazyRouteComponent, createRouter, useRouter } from "@tanstack/react-router";
...
function PageHeader({ title, subtitle }) {
  ...
  return /* @__PURE__ */ jsxs("header", { className: "mb-6 pt-6 flex items-start justify-between", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxs("button", { className: "p-2 rounded-full hover:bg-muted text-muted-foreground transition-colors relative", children: [
        /* @__PURE__ */ jsx(Bell, { className: "w-5 h-5" }),
        /* @__PURE__ */ jsx("span", { className: "absolute top-1.5 right-1.5 w-2 h-2 bg-primary rounded-full border border-background" })
      ] }),
      /* @__PURE__ */ jsx(
        "button",
        {
...
const appCss = "/assets/styles-DzXSHQDL.css";
...
const $$splitComponentImporter$c = () => import("./workflow-BaNMi1Fo.js");
const Route$c = createFileRoute("/workflow")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$b = () => import("./verify-bzB8WMYR.js");
const Route$b = createFileRoute("/verify")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./signup-CnW9eIfG.js");
const Route$a = createFileRoute("/signup")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./profile-3V7exOrY.js");
...
const $$splitComponentImporter$8 = () => import("./login-DErEV948.js");
const Route$8 = createFileRoute("/login")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./diagnosis-acLbJDr8.js");
const Route$7 = createFileRoute("/diagnosis")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$6 = () => import("./anatomy-DyiDugRz.js");
const Route$6 = createFileRoute("/anatomy")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$5 = () => import("./index-FDwuVWDr.js");
const Route$5 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./tools.index-CcZ-MBF4.js");
...
const RUBBER_DAM_TIPS = [
  {
    category: "Anteriors",
    details: "Butterfly clamp (W2/W2A) or Ivory #9 for incisors; #00 for smaller teeth; winged clamps allow simultaneous placement"
  },
  {
    category: "Premolars",
    details: "#2 (universal premolar); #2A for smaller premolars; W8A (wingless) for sub-gingival margins"
  },
  {
    category: "Molars",
    details: "#14/14A for maxillary molars; #7 or #56 for mandibular molars; #8A for partially erupted"
  },
  {
    category: "Broken-down teeth",
    details: "Build up with GIC/composite band before clamping; consider #212 or #26N for minimal structure"
  },
  {
    category: "Isolation strategy",
    details: "Single-tooth isolation preferred for endo; clamp on the tooth being treated; frame placement before inversion"
  },
  {
    category: "Punching holes",
    details: "Use correct hole size from punch template; single hole for endo; position tooth correctly on dam grid"
  },
  {
    category: "Inversion technique",
    details: "Use flat plastic or explorer to tuck dam into sulcus; dry tooth first; air from 3-in-1 syringe helps"
  },
  {
    category: "Common problems",
    details: "Dam tears: use heavy-gauge dam; clamp slips: ensure 4-point contact; leakage: use OraSeal/dam sealant"
  },
  {
    category: "Special situations",
    details: "Braces: wedjets or floss ties; Bridges: pass dam under pontic; Crowns: clamp may need to be inverted (jaws-down)"
  }
];
const $$splitComponentImporter$3 = () => import("./workflow_.summary-BLKJnsOP.js");
...
const Route$3 = createFileRoute("/workflow_/summary")({
...
const $$splitComponentImporter$2 = () => import("./tools.rubber-dam-B_mDNsu6.js");
...
const $$splitComponentImporter$1 = () => import("./tools.irrigation-BpodL6aI.js");
...
const $$splitComponentImporter = () => import("./tools.file-calculator-C6_76zYZ.js");
...
const WorkflowRoute = Route$c.update({
  id: "/workflow",
  path: "/workflow",
  getParentRoute: () => Route$d
});
const VerifyRoute = Route$b.update({
  id: "/verify",
  path: "/verify",
  getParentRoute: () => Route$d
});
...
const DiagnosisRoute = Route$7.update({
  id: "/diagnosis",
  path: "/diagnosis",
  getParentRoute: () => Route$d
});
const AnatomyRoute = Route$6.update({
  id: "/anatomy",
  path: "/anatomy",
  getParentRoute: () => Route$d
});
...
const ToolsIndexRoute = Route$4.update({
  id: "/tools/",
  path: "/tools/",
  getParentRoute: () => Route$d
});
