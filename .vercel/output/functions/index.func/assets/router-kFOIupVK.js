...
function PhoneFrame({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-muted/40 flex justify-center min-[400px]:items-center min-[400px]:py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full min-[400px]:w-[390px] min-[400px]:h-[844px] min-[400px]:max-h-[calc(100vh-4rem)] min-[400px]:rounded-[2.5rem] min-[400px]:border-[10px] min-[400px]:border-foreground/90 min-[400px]:shadow-2xl min-[400px]:overflow-hidden bg-background flex flex-col min-h-screen min-[400px]:min-h-0 relative", children }) });
}
const tabs = [
...
function AppShell() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PhoneFrame, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: `flex-1 ${!isAuthPage ? "pb-24" : ""} px-5 pt-6 overflow-y-auto`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }),
    !isAuthPage && /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "absolute bottom-0 left-0 right-0 bg-card/95 backdrop-blur-sm border-t border-border animate-in slide-in-from-bottom-full duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "grid grid-cols-5 px-2 py-2", children: tabs.map((t) => {
...
function PageHeader({ title, subtitle }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "mb-6", children: [
...
const appCss = "/assets/styles-C0jJR3Lp.css";
...
const $$splitComponentImporter$b = () => import("./workflow-DDVU1R9P.js");
...
const $$splitComponentImporter$a = () => import("./tools-DDesaUO7.js");
...
const $$splitComponentImporter$9 = () => import("./signup-jCb8fUbh.js");
const Route$9 = createFileRoute("/signup")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./profile-AV_9R4-y.js");
...
const $$splitComponentImporter$7 = () => import("./login-DIMCcV7t.js");
const Route$7 = createFileRoute("/login")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./diagnosis-DAykVVHo.js");
...
const $$splitComponentImporter$5 = () => import("./anatomy-C5jcBsJO.js");
...
const $$splitComponentImporter$4 = () => import("./index-cyvtvNN4.js");
...
ZodOptional.create;
ZodNullable.create;
const $$splitComponentImporter$3 = () => import("./workflow.summary-CwQHZK3A.js");
const searchSchema = objectType({
  tooth: stringType().optional().default("16"),
  dx: stringType().optional().default("normal"),
  files: enumType(FILE_SYSTEMS).optional().default("ProTaper Gold")
});
...
const $$splitComponentImporter$2 = () => import("./tools.rubber-dam-DFfqy8lr.js");
...
const $$splitComponentImporter$1 = () => import("./tools.irrigation-B9rht4O1.js");
...
const $$splitComponentImporter = () => import("./tools.file-calculator-dwRciJ7Y.js");
const Route2 = createFileRoute("/tools/file-calculator")({
  head: () => ({
    meta: [{
...
const ToolsFileCalculatorRoute = Route2.update({
  id: "/file-calculator",
